...
public:
	...
	/// Returns a function name that wraps around returndatacopy().
	///
	/// If returndatacopy() is not supported by the underlying target, a zeroPointer will be
	/// returned instead.
	std::string returndatacopyFunction();
